...
const Sidebar = () => {
  ...
  return (
    <aside className="w-72 bg-white dark:bg-darkbg-surface border-r border-warm-200/50 dark:border-darkbg-border h-screen flex flex-col justify-between p-4 md:p-5 fixed left-0 top-0 z-20 shadow-sm no-print">
      {/* Header / Logo */}
      <div className="flex flex-col shrink-0 pb-3 border-b border-warm-200/50 dark:border-darkbg-border">
